...
public class Payment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Electric Charges");
        ...
        jLabel5.setText("Electricity Billing System");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double k = i - j;
        jTextField3.setText(Double.toString(k));
        ...
        try {
            ...
            while (rs.next()) {
            String query = "update users set Topay = " + k + " where id = " + uid;
        ...
        try {
                    ...
                    Statement stmt = connection.createStatement();
            ResultSet rs1 = stmt.executeQuery("SELECT * FROM users WHERE id = " + uid);
            while (rs1.next()) {
                double n = rs1.getDouble("outdate");
                if(n >= l)
                {
                    m = n - l;
                }
            ...
            String query = "update users set outdate = " + m + " where id = " + uid;
            PreparedStatement preparedStmt = connection.prepareStatement(query);
            preparedStmt.executeUpdate();
            }
            } catch (SQLException sqlException) {
